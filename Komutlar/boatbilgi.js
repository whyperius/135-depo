...
exports.run = async (client, message, args) => {
  ...
  const Crewistatistikler = new Discord.MessageEmbed()
    ...
    .addField(
      `» Linkler`,
      `** [Destek Sunucusu](https://discord.gg/JyMsba3du5) **`,
      true
    );
